...
export function SocialShare({
  ...
  description = "Convert images between WebP, AVIF, PNG, JPEG formats instantly in your browser. Free, fast, and secure!",
  hashtags = ["imageconverter", "webp", "avif", "optimization"],
  className = "",
}: SocialShareProps) {
